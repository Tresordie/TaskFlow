...
/// v1.10.0 contract tests for the Today kanban board data layer:
/// column bucketing, in-column ordering, quick filters and KPI stats.
/// All functions under test are pure — no Isar needed.
  ...
  group('sortKanbanTasks', () {
    test('earliest due first, no due date last, then priority, then newest',
      ...
      final list = [
        ...
        _task(4, due: null, priority: Priority.p2Medium,
            created: DateTime(2026, 9, 2)),
        _task(5, due: null, priority: Priority.p1High,
