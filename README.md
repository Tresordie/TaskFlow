...
- Custom date-range picker (Timeline / Calendar / Reports): themed card-aligned dialog, 480×500 layout scaled 1.1× into a 528×550 near-native popup (zero side margins, 6-row months fully visible), localized copy
